...
-  Since V18, the sale_invoice_policy functionality ahs been moved to
   the ecommerce_connector_sale_invoice_policy module. If you are
   migrating from older versions, you should also install this module.
